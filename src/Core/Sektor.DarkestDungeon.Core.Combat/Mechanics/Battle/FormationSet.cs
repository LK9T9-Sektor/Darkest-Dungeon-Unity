...
namespace Sektor.DarkestDungeon.Core.Combat.Mechanics.Battle
{
    ...
    public class FormationSet
    {
        ...
        public Mechanics.SkillTargetType SkillTargetType
        {
            get
            {
                if (IsSelfTarget)
                    return Mechanics.SkillTargetType.Self;

                return IsSelfFormation ? Mechanics.SkillTargetType.Party : Mechanics.SkillTargetType.Enemy;
            }
        }
