...
- **Фаза 0. Реструктуризация в монорепо.** Перенос активного проекта в `unity\`; `.gitignore` на обе раскладки; тулзы `-ProjectPath`; доставка ядра в оба проекта; compile-check обеих версий.
