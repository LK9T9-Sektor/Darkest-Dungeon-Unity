...
## 11. Steam-приглашение (Join Game / +connect_lobby) не срабатывает
...
- Приходится вручную вводить lobby ID (в слот общего списка комнат в Steam-режиме; ID выводится в логе
  хоста после создания сессии) — это текущий рабочий способ подключения клиента.
