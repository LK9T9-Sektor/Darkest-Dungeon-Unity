...
public class StageCoachWindow : BuildingWindow
{
    ...
    public override void WindowOpened()
    {
        if (!TownManager.AnyWindowsOpened)
        {
            ...
            DarkestSoundManager.Instanse.ExecuteNarration("enter_building", NarrationPlace.Town, "stage_coach");
            DarkestSoundManager.Instanse.PlayOneShot("event:/town/enter_stage_coach");
        }
    }
