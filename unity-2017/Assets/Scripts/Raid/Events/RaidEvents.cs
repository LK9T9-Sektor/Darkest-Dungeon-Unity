    ...
    public void ShowPopupMessage(FormationUnit unit, PopupMessageType type, string parameter = "", float ripOffset = 0)
    {
        ...
        switch(type)
        {
            ...
            case PopupMessageType.HeartAttack:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/char/heart_attack");
                break;
            case PopupMessageType.RetreatFailed:
                popupMessage.SetColor(PopupColors["pop_text_heart_attack"], PopupColors["pop_text_outline_heart_attack"]);
                popupMessage.SetMessage(LocalizationManager.GetString("retreat_fail_announcement"));
                popupMessage.SetOffset(new Vector3(0, ripOffset, 0));
                DarkestSoundManager.PlayOneShot("event:/general/combat/retreat_fail");
                break;
            ...
            case PopupMessageType.Stress:
                ...
                popupMessage.SetMessage(parameter);
                DarkestSoundManager.PlayOneShot("event:/general/status/stress_up");
                popupMessage.SkillMessage.fontSize = 70;
                break;
            case PopupMessageType.StressHeal:
                ...
                popupMessage.SetMessage(parameter);
                DarkestSoundManager.PlayOneShot("event:/general/status/stress_down");
                popupMessage.SkillMessage.fontSize = 70;
                break;
            ...
            case PopupMessageType.Pass:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/char/pass");
                break;
            case PopupMessageType.Tagged:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/marked");
                break;
            ...
            case PopupMessageType.Bleed:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/bleed_onset");
                break;
            case PopupMessageType.Poison:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/poison_onset");
                break;
            case PopupMessageType.Buff:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/buff");
                break;
            case PopupMessageType.Debuff:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/debuff");
                break;
            case PopupMessageType.Stunned:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/stun_onset");
                break;
            case PopupMessageType.Unstun:
                ...
                popupMessage.SetMessage(LocalizationManager.GetString("str_ui_stun"));
                DarkestSoundManager.PlayOneShot("event:/general/status/stun_off");
                break;
            case PopupMessageType.Cured:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/cured");
                break;
            case PopupMessageType.BleedResist:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/resist");
                break;
            ...
            case PopupMessageType.Disease:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/char/quirk_neg");
                break;
            case PopupMessageType.PositiveQuirk:
                popupMessage.SetColor(PopupColors["notable"], Color.black);
                popupMessage.SetMessage(parameter);
                popupMessage.SetOffset(new Vector3(0, 70, 0));
                DarkestSoundManager.PlayOneShot("event:/general/char/quirk_pos");
                break;
            ...
            case PopupMessageType.Guard:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/guard");
                break;
            case PopupMessageType.Riposte:
                ...
                DarkestSoundManager.PlayOneShot("event:/general/status/riposte_enabled");
                break;
        }
