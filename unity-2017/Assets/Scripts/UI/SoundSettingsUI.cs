...
public class SoundSettingsUI : MonoBehaviour
{
    ...
    private const int _sortingOrder = 30000;
    ...
    private void CreateUi()
    {
        ...
        Canvas canvas = RuntimeUiFactory.CreateCanvas("SoundSettingsCanvas", transform, _sortingOrder);
    ...
    {
        GameObject buttonObject = RuntimeUiFactory.CreateUiObject("AudioButton", parent);
        ...
        background.color = _settingsButtonSprite != null
            ? Color.white
            : RuntimeUiFactory.ToColor(UiStyle.ButtonBackground);
    ...
    {
        GameObject panelObject = RuntimeUiFactory.CreateUiObject("AudioPanel", parent);
    ...
    {
        _title = RuntimeUiFactory.CreateText("SettingsTitle", parent, _titleLabelFallback,
    ...
    private void CreateCloseButton(Transform parent)
    {
        ...
        RuntimeUiFactory.CreateStepperButton(parent, "CloseButton", closeIcon, new Vector2(476, 334), TogglePanel);
    }

    private void CreateReturnButton(Transform parent)
    {
        GameObject buttonObject = RuntimeUiFactory.CreateUiObject("ReturnButton", parent);
        RectTransform rect = buttonObject.GetComponent<RectTransform>();
        rect.anchorMin = new Vector2(0.5f, 0.5f);
        rect.anchorMax = new Vector2(0.5f, 0.5f);
        rect.pivot = new Vector2(0.5f, 0.5f);
        ...
        _returnButtonLabel = RuntimeUiFactory.CreateText("ReturnLabel", buttonObject.transform, _returnButtonLabelFallback,
            new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(0, 3), new Vector2(236, 43),
            UiStyle.ReturnButton, UiStyle.Label);
    }
        ...
        out Text label, out Text valueText, UnityAction decrease, UnityAction increase)
    {
        ...
        label = RuntimeUiFactory.CreateText("VolumeLabel", parent, labelFallback,
            new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(-120, rowY), new Vector2(200, 28),
            UiStyle.Small, UiStyle.Label);

        valueText = RuntimeUiFactory.CreateText("VolumeValue", parent, "0",
            new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(115, rowY), new Vector2(44, 32),
            UiStyle.Value, UiStyle.Label);

        Sprite minusArrow = _sprites != null ? _sprites.MinusArrow : null;
        Sprite plusArrow = _sprites != null ? _sprites.PlusArrow : null;
        RuntimeUiFactory.CreateStepperButton(parent, "VolumeMinus", minusArrow, new Vector2(77, rowY), decrease);
        RuntimeUiFactory.CreateStepperButton(parent, "VolumePlus", plusArrow, new Vector2(153, rowY), increase);
    }
