...
- **Стрелка атаки при наведении**: на своём ходу после выбора способности или MOVE при ховере на валидную цель поверх поля боя показывается «полоса» из предсозданных прямоугольников — тонкая у краёв и максимальная в центре поля, фиксированный полный пролёт (левая команда col3→col0, правая col0→col3) независимо от рангов.
