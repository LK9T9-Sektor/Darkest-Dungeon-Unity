...
**Детальные спецификации (условия, порядок срабатывания, очереди, нюансы, `file:line`) — в
`docs\mechanics\<domain>\` (навигатор: `docs\mechanics\00_index.md`)**; здесь — сводная таблица
расхождений и быстрые факты.
...
> Детали: `mechanics\combat\14_death_stress.md`.
...
> Детали: `mechanics\combat\01_damage.md`.
...
> Детали: `mechanics\combat\13_turn_order.md`.
...
> Детали: `mechanics\combat\02_dot.md`, `03_stun.md`, `04_riposte.md`, `05_guard.md`, `06_mark.md`,
> `07_rank_move.md`, `08_immobilize.md`, `09_buffs.md`, `10_torch.md`.
...
> Детали: `mechanics\combat\11_modes.md`.
...
> Детали: `mechanics\combat\12_surprise.md`.
