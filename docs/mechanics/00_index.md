...
| 15 | Disease: `.disease any|<id>`, резист, применение квирка | `15_disease.md` | частично |
| 16 | Размер юнита: size 1–4, кумулятивные ранги, ёмкость 4 слотов | `16_formation_size.md` | реализовано |
